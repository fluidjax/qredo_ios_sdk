...
-(void)testInitWithPkcs8KeyData_KeyDataFromBouncyCastle
{
    ...
    QredoRsaPublicKey *publicKey = [[QredoRsaPublicKey alloc] initWithPkcs8KeyData:keyData];
    XCTAssertNotNil(publicKey, @"Public key should not be nil.");
    XCTAssertNotNil(publicKey.modulus, @"Modulus should not be nil.");
    XCTAssertNotNil(publicKey.publicExponent, @"Public exponent should not be nil.");
}
...
- (void)testConvertToPkcs8Format_FromPkcs8Data
{
    ...
    NSData *pkcs1Data = [publicKey convertToPkcs8Format];
