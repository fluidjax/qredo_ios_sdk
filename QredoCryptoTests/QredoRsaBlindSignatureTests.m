//
//  QredoRsaBlindSignatureTests.m
//  QredoSDK
//
//  Created by David Hearn on 02/10/2014.
//
//
...
- (void)testBlindMessage
{
    ...
    NSLog(@"Modulus: %@.", [QredoLogging printBytesAsHex:modulus numberOfBytes:(unsigned int)modulusLength]);
    NSLog(@"Exponent: %@.", [QredoLogging printBytesAsHex:publicExponent numberOfBytes:(unsigned int)publicExponentLength]);
    NSLog(@"Message: %@.", [QredoLogging printBytesAsHex:message numberOfBytes:(unsigned int)messageLength]);
    NSLog(@"BlindingFactor: %@.", [QredoLogging printBytesAsHex:blindingFactor numberOfBytes:(unsigned int)blindingFactorLength]);
    NSLog(@"BlindedMessage: %@.", [QredoLogging printBytesAsHex:blindedMessage numberOfBytes:(unsigned int)blindedMessageLength]);
}
...
- (void)testUnblindSignature
{
    ...
    NSLog(@"Modulus: %@.", [QredoLogging printBytesAsHex:modulus numberOfBytes:(unsigned int)modulusLength]);
    NSLog(@"BlindingFactor: %@.", [QredoLogging printBytesAsHex:blindingFactor numberOfBytes:(unsigned int)blindingFactorLength]);
    NSLog(@"BlindedSignature: %@.", [QredoLogging printBytesAsHex:blindedSignature numberOfBytes:(unsigned int)blindedSignatureLength]);
    NSLog(@"UnblindedSignature: %@.", [QredoLogging printBytesAsHex:unblindedSignature numberOfBytes:(unsigned int)unblindedSignatureLength]);
}
...
- (void)testBlindSignUnblindRoundTrip
{
    ...
    XCTAssertTrue(privateKey != NULL, @"Failed to get SecKeyRef for imported key.");
    ...
    NSLog(@"BlindingFactor: %@.", [QredoLogging printBytesAsHex:blindingFactor numberOfBytes:(unsigned int)blindingFactorLength]);
    NSLog(@"BlindedMessage: %@.", [QredoLogging printBytesAsHex:blindedMessage numberOfBytes:(unsigned int)blindedMessageLength]);
    NSLog(@"NormalSignature: %@.", [QredoLogging printBytesAsHex:normalSignature numberOfBytes:(unsigned int)normalSignatureLength]);
    NSLog(@"BlindedSignature: %@.", [QredoLogging printBytesAsHex:blindedSignature numberOfBytes:(unsigned int)blindedSignatureLength]);
    NSLog(@"UnblindedSignature: %@.", [QredoLogging printBytesAsHex:unblindedSignature numberOfBytes:(unsigned int)unblindedSignatureLength]);
}
...
- (void)testUnblindSignature_BCGeneratedData
{
    ...
    NSLog(@"BlindingFactor: %@.", [QredoLogging printBytesAsHex:blindingFactor numberOfBytes:(unsigned int)blindingFactorLength]);
    NSLog(@"BlindedSignature: %@.", [QredoLogging printBytesAsHex:blindedSignature numberOfBytes:(unsigned int)blindedSignatureLength]);
    NSLog(@"ExpectedUnblindedSignature: %@.", [QredoLogging printBytesAsHex:expectedUnblindedSignature numberOfBytes:(unsigned int)expectedUnblindedSignatureLength]);
    NSLog(@"UnblindedSignature: %@.", [QredoLogging printBytesAsHex:unblindedSignature numberOfBytes:(unsigned int)unblindedSignatureLength]);
}
...
- (void)testGenerateRandomInteger
{
    ...
    NSLog(@"Generated random integer 1: %s. Bitcount = %d (requested = %d).", outputString1, bitCount1, bitCount);
    NSLog(@"Generated random integer 2: %s. Bitcount = %d (requested = %d).", outputString2, bitCount2, bitCount);
...
- (void)testGenerateRandomIntegerLessThanAnother
{
    ...
    NSLog(@"Generated comparison integer: %s", outputString1);
    NSLog(@"Generated random integer: %s", outputString2);
