//
//  QredoRsaPrivateKeyTests.m
//  QredoSDK
//
//  Created by David Hearn on 19/09/2014.
//
//
...
-(void)testInitWithPkcs1KeyData_GeneratedKeyData
{
    ...
    // Optional dump of key data
//    LogDebug(@"Private key version: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.version]);
//    LogDebug(@"Private key modulus: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.modulus]);
//    LogDebug(@"Private key publicExponent: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.publicExponent]);
//    LogDebug(@"Private key privateExponent: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.privateExponent]);
//    LogDebug(@"Private key crtPrime1: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.crtPrime1]);
//    LogDebug(@"Private key crtPrime2: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.crtPrime2]);
//    LogDebug(@"Private key crtExponent1: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.crtExponent1]);
//    LogDebug(@"Private key crtExponent2: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.crtExponent2]);
//    LogDebug(@"Private key crtCoefficient: %@.", [QredoLogging hexRepresentationOfNSData:privateKey.crtCoefficient]);
}
