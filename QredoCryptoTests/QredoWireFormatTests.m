...
#import "NSUUID+QredoUUIDEquality.h"
...
- (void)testDate {
    ...
    XCTAssertTrue([[actualDate1 year]  isEqualToNumber:@1983]);
    XCTAssertTrue([[actualDate1 month] isEqualToNumber:@4]);
    XCTAssertTrue([[actualDate1 day]   isEqualToNumber:@12]);
    
    XCTAssertNotNil(actualDate2);
    XCTAssertTrue([[actualDate2 year]  isEqualToNumber:@1982]);
    XCTAssertTrue([[actualDate2 month] isEqualToNumber:@1]);
    XCTAssertTrue([[actualDate2 day]   isEqualToNumber:@1]);
    
    XCTAssertNotNil(actualDate3);
    XCTAssertTrue([[actualDate3 year]  isEqualToNumber:@2006]);
    XCTAssertTrue([[actualDate3 month] isEqualToNumber:@2]);
    XCTAssertTrue([[actualDate3 day]   isEqualToNumber:@15]);
    
    XCTAssertNotNil(actualDate4);
    XCTAssertTrue([[actualDate4 year]  isEqualToNumber:@2009]);
    XCTAssertTrue([[actualDate4 month] isEqualToNumber:@11]);
    XCTAssertTrue([[actualDate4 day]   isEqualToNumber:@25]);
    
    XCTAssertNotNil(actualDate5);
    XCTAssertTrue([[actualDate5 year]  isEqualToNumber:@2013]);
    XCTAssertTrue([[actualDate5 month] isEqualToNumber:@12]);
    XCTAssertTrue([[actualDate5 day]   isEqualToNumber:@23]);
...
- (void)testDateFromNSDate {
    ...
    XCTAssertTrue([[actualDate year]  isEqualToNumber:@1983]);
    XCTAssertTrue([[actualDate month] isEqualToNumber:@4]);
    XCTAssertTrue([[actualDate day]   isEqualToNumber:@12]);
...
- (void)testGenericDateTime {
    ...
    XCTAssertTrue([[[actualGenericDateTime1 date] year]  isEqualToNumber:@1983]);
    XCTAssertTrue([[[actualGenericDateTime1 date] month] isEqualToNumber:@4]);
    XCTAssertTrue([[[actualGenericDateTime1 date] day]   isEqualToNumber:@12]);
    XCTAssertTrue([[[actualGenericDateTime1 time] millisSinceMidnight] isEqualToNumber:@1000]);

    XCTAssertTrue([actualGenericDateTime2 isMemberOfClass:[QredoLocalDateTime class]]);
    XCTAssertTrue([[[actualGenericDateTime2 date] year]  isEqualToNumber:@1983]);
    XCTAssertTrue([[[actualGenericDateTime2 date] month] isEqualToNumber:@4]);
    XCTAssertTrue([[[actualGenericDateTime2 date] day]   isEqualToNumber:@12]);
    XCTAssertTrue([[[actualGenericDateTime2 time] millisSinceMidnight] isEqualToNumber:@1000]);
...
- (void)testLocalDateTime {
    ...
    XCTAssertTrue([[[actualLocalDateTime1 date] year]  isEqualToNumber:@1983]);
    XCTAssertTrue([[[actualLocalDateTime1 date] month] isEqualToNumber:@4]);
    XCTAssertTrue([[[actualLocalDateTime1 date] day]   isEqualToNumber:@12]);
    XCTAssertTrue([[[actualLocalDateTime1 time] millisSinceMidnight] isEqualToNumber:@1000]);
    
    XCTAssertTrue([[[actualLocalDateTime2 date] year]  isEqualToNumber:@1982]);
    XCTAssertTrue([[[actualLocalDateTime2 date] month] isEqualToNumber:@1]);
    XCTAssertTrue([[[actualLocalDateTime2 date] day]   isEqualToNumber:@1]);
    XCTAssertTrue([[[actualLocalDateTime2 time] millisSinceMidnight] isEqualToNumber:@4000]);
    
    XCTAssertTrue([actualGenericDateTime3 isMemberOfClass:[QredoLocalDateTime class]]);
    XCTAssertTrue([[[actualGenericDateTime3 date] year]  isEqualToNumber:@1983]);
    XCTAssertTrue([[[actualGenericDateTime3 date] month] isEqualToNumber:@4]);
    XCTAssertTrue([[[actualGenericDateTime3 date] day]   isEqualToNumber:@12]);
    XCTAssertTrue([[[actualGenericDateTime3 time] millisSinceMidnight] isEqualToNumber:@1000]);
    
    XCTAssertTrue([actualGenericDateTime4 isMemberOfClass:[QredoLocalDateTime class]]);
    XCTAssertTrue([[[actualGenericDateTime4 date] year]  isEqualToNumber:@1982]);
    XCTAssertTrue([[[actualGenericDateTime4 date] month] isEqualToNumber:@1]);
    XCTAssertTrue([[[actualGenericDateTime4 date] day]   isEqualToNumber:@1]);
    XCTAssertTrue([[[actualGenericDateTime4 time] millisSinceMidnight] isEqualToNumber:@4000]);
...
- (void)testSymbol {
    ...
    NSString *testSymbol4 = @"Invalid-Symbol-1";
    NSString *testSymbol5 = @"2nd_InvalidSymbol";
    ...
    XCTAssertThrows([writer writeSymbol:testSymbol4], @"Should throw QredoInvalidSymbol.");
    XCTAssertThrows([writer writeSymbol:testSymbol5], @"Should throw QredoInvalidSymbol.");
    [writer writeEnd];
    NSData *data = [out propertyForKey:NSStreamDataWrittenToMemoryStreamKey];
    [out close];
...
- (void)testTime {
    ...
    XCTAssertTrue([[actualTime1 millisSinceMidnight] isEqualToNumber:[testTime1 millisSinceMidnight]]);
    XCTAssertTrue([[actualTime2 millisSinceMidnight] isEqualToNumber:[testTime2 millisSinceMidnight]]);
    XCTAssertTrue([[actualTime3 millisSinceMidnight] isEqualToNumber:[testTime3 millisSinceMidnight]]);
...
- (void)testTimeFromNSDate {
    ...
    XCTAssertTrue([[actualTime hour]   isEqualToNumber:@12]);
    XCTAssertTrue([[actualTime minute] isEqualToNumber:@0]);
    XCTAssertTrue([[actualTime second] isEqualToNumber:@0]);
    XCTAssertTrue([[actualTime milli]  isEqualToNumber:@0]);
...
- (void)testTimeFromNSDateComponents {
    ...
    XCTAssertNotNil(actualTime);
    XCTAssertTrue([[actualTime hour]   isEqualToNumber:@12]);
    XCTAssertTrue([[actualTime minute] isEqualToNumber:@34]);
    XCTAssertTrue([[actualTime second] isEqualToNumber:@56]);
    XCTAssertTrue([[actualTime milli]  isEqualToNumber:@0]);
...
- (void)testUUID {
    ...
    NSUUID *testUUID1 = [NSUUID UUID];
    NSUUID *testUUID2 = [NSUUID UUID];
    NSUUID *testUUID3 = [NSUUID UUID];
    
    NSOutputStream *out = [NSOutputStream outputStreamToMemory];
    [out open];
    QredoWireFormatWriter *writer = [QredoWireFormatWriter wireFormatWriterWithOutputStream:out];
    [writer writeStart];
    [writer writeUUID:testUUID1];
    [writer writeUUID:testUUID2];
    [writer writeUUID:testUUID3];
    [writer writeEnd];
    NSData *data = [out propertyForKey:NSStreamDataWrittenToMemoryStreamKey];
    [out close];
    ...
    QredoWireFormatReader *reader = [QredoWireFormatReader wireFormatReaderWithInputStream:in];
    [reader readStart];
    NSUUID *actualUUID1 = [reader readUUID];
    NSUUID *actualUUID2 = [reader readUUID];
    NSUUID *actualUUID3 = [reader readUUID];
    XCTAssertTrue([reader atEnd]);
    [reader readEnd];
    XCTAssertFalse([in hasBytesAvailable]);
    [in close];
    
    XCTAssertNotNil(actualUUID1);
    XCTAssertNotNil(actualUUID2);
    XCTAssertNotNil(actualUUID3);
    
    XCTAssertTrue([actualUUID1 isEqualToUUID:testUUID1]);
    XCTAssertTrue([actualUUID2 isEqualToUUID:testUUID2]);
    XCTAssertTrue([actualUUID3 isEqualToUUID:testUUID3]);
...
- (void)testUTCDateTime {
    ...
    XCTAssertTrue([[[actualUTCDateTime1 date] year]  isEqualToNumber:@1983]);
    XCTAssertTrue([[[actualUTCDateTime1 date] month] isEqualToNumber:@4]);
    XCTAssertTrue([[[actualUTCDateTime1 date] day]   isEqualToNumber:@12]);
    XCTAssertTrue([[[actualUTCDateTime1 time] millisSinceMidnight] isEqualToNumber:@1000]);
    
    XCTAssertTrue([[[actualUTCDateTime2 date] year]  isEqualToNumber:@1982]);
    XCTAssertTrue([[[actualUTCDateTime2 date] month] isEqualToNumber:@1]);
    XCTAssertTrue([[[actualUTCDateTime2 date] day]   isEqualToNumber:@1]);
    XCTAssertTrue([[[actualUTCDateTime2 time] millisSinceMidnight] isEqualToNumber:@4000]);
...
- (void)testInterchangeHeader {
    ...
    NSData *testReturnChannelID = [QredoCrypto secureRandomWithSize:@16];
    NSData *testCorrelationID   = [QredoCrypto secureRandomWithSize:@16];
    ...
    XCTAssertTrue([[actualInterchangeHeader returnChannelID] isEqual:testReturnChannelID]);
    XCTAssertTrue([[actualInterchangeHeader correlationID]   isEqual:testCorrelationID]);
    XCTAssertTrue([[actualInterchangeHeader serviceName]     isEqual:testServiceName]);
    XCTAssertTrue([[actualInterchangeHeader operationName]   isEqual:testOperationName]);
...
- (void)testErrorInfoItems {
    ...
    XCTAssertTrue([[actualErrorInfo1 code] isEqualToNumber:@123]);
    ...
    XCTAssertTrue([[actualErrorInfo2 code] isEqualToNumber:@456]);
    ...
    XCTAssertTrue([[actualErrorInfo3 code] isEqualToNumber:@789]);
