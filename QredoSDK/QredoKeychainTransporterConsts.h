...
NSString *const QredoKeychainTransporterMessageTypeConfirmReceiving;
NSString *const QredoKeychainTransporterMessageTypeCancelReceiving;
NSString *const QredoKeychainTransporterMessageKeyDeviceName;
