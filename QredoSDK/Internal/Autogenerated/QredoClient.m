...
-(BOOL)isEqualToCachedVaultItem:(QLFCachedVaultItem *)other {
    ...
    if (_encryptedItem != other.encryptedItem && ![_encryptedItem isEqual:other.encryptedItem])return NO;
    
    if (_authCode != other.authCode && ![_authCode isEqual:other.authCode])return NO;
...
-(BOOL)isEqualToConversationPublishResult:(QLFConversationPublishResult *)other {
    ...
    if (_sequenceValue != other.sequenceValue && ![_sequenceValue isEqual:other.sequenceValue])return NO;
...
-(BOOL)isEqualToEncryptedConversationItem:(QLFEncryptedConversationItem *)other {
    ...
    if (_encryptedMessage != other.encryptedMessage && ![_encryptedMessage isEqual:other.encryptedMessage])return NO;
...
-(BOOL)isEqualToConversationItemWithSequenceValue:(QLFConversationItemWithSequenceValue *)other {
    ...
    if (_item != other.item && ![_item isEqual:other.item])return NO;
...
-(BOOL)isEqualToConversationQueryItemsResult:(QLFConversationQueryItemsResult *)other {
    ...
    if (_items != other.items && ![_items isEqual:other.items])return NO;
    
    if (_maxSequenceValue != other.maxSequenceValue && ![_maxSequenceValue isEqual:other.maxSequenceValue])return NO;
    
    if (_current != other.current)return NO;
...
-(BOOL)isEqualToEncryptedRecoveryInfoType:(QLFEncryptedRecoveryInfoType *)other {
    ...
    if (_credentialType != other.credentialType)return NO;
    
    if (_encryptedMasterKey != other.encryptedMasterKey && ![_encryptedMasterKey isEqual:other.encryptedMasterKey])return NO;
...
-(BOOL)isEqualToEncryptedKeychain:(QLFEncryptedKeychain *)other {
    ...
    if (_encryptedKeyChain != other.encryptedKeyChain && ![_encryptedKeyChain isEqual:other.encryptedKeyChain])return NO;
    
    if (_encryptedRecoveryInfo != other.encryptedRecoveryInfo && ![_encryptedRecoveryInfo isEqual:other.encryptedRecoveryInfo])return NO;
...
-(BOOL)isEqualToKeyLF:(QLFKeyLF *)other {
    ...
    if (_bytes != other.bytes && ![_bytes isEqual:other.bytes])return NO;
...
-(BOOL)isEqualToKeyPairLF:(QLFKeyPairLF *)other {
    ...
    if (_pubKey != other.pubKey && ![_pubKey isEqual:other.pubKey])return NO;
    
    if (_privKey != other.privKey && ![_privKey isEqual:other.privKey])return NO;
...
-(BOOL)isEqualToRecoveryInfoType:(QLFRecoveryInfoType *)other {
    ...
    if (_masterKey != other.masterKey && ![_masterKey isEqual:other.masterKey])return NO;
...
-(BOOL)isEqualToRendezvousAuthX509_PEM:(QLFRendezvousAuthX509_PEM *)other {
    ...
    if (_signature != other.signature && ![_signature isEqual:other.signature])return NO;
...
-(BOOL)isEqualToEncryptedResponderInfo:(QLFEncryptedResponderInfo *)other {
    ...
    if (_value != other.value && ![_value isEqual:other.value])return NO;
    
    if (_authenticationCode != other.authenticationCode && ![_authenticationCode isEqual:other.authenticationCode])return NO;
    
    if (_authenticationType != other.authenticationType && ![_authenticationType isEqual:other.authenticationType])return NO;
...
-(BOOL)isEqualToRendezvousCreationInfo:(QLFRendezvousCreationInfo *)other {
    ...
    if (_hashedTag != other.hashedTag && ![_hashedTag isEqual:other.hashedTag])return NO;
    
    if (_durationSeconds != other.durationSeconds && ![_durationSeconds isEqual:other.durationSeconds])return NO;
    
    if (_responseCountLimit != other.responseCountLimit && ![_responseCountLimit isEqual:other.responseCountLimit])return NO;
    
    if (_ownershipPublicKey != other.ownershipPublicKey && ![_ownershipPublicKey isEqual:other.ownershipPublicKey])return NO;
    
    if (_encryptedResponderInfo != other.encryptedResponderInfo && ![_encryptedResponderInfo isEqual:other.encryptedResponderInfo])return NO;
...
-(BOOL)isEqualToRendezvousResponseRegistered:(QLFRendezvousResponseRegistered *)other {
    ...
    if (_info != other.info && ![_info isEqual:other.info])return NO;
...
-(BOOL)isEqualToRendezvousResponseRejected:(QLFRendezvousResponseRejected *)other {
    ...
    if (_reason != other.reason && ![_reason isEqual:other.reason])return NO;
...
-(BOOL)isEqualToRendezvousResponse:(QLFRendezvousResponse *)other {
    ...
    if (_responderPublicKey != other.responderPublicKey && ![_responderPublicKey isEqual:other.responderPublicKey])return NO;
    
    if (_responderAuthenticationCode != other.responderAuthenticationCode && ![_responderAuthenticationCode isEqual:other.responderAuthenticationCode])return NO;
...
-(BOOL)isEqualToRendezvousResponseWithSequenceValue:(QLFRendezvousResponseWithSequenceValue *)other {
    ...
    if (_response != other.response && ![_response isEqual:other.response])return NO;
    
    if (_sequenceValue != other.sequenceValue)return NO;
...
-(BOOL)isEqualToRendezvousResponsesResult:(QLFRendezvousResponsesResult *)other {
    ...
    if (_responses != other.responses && ![_responses isEqual:other.responses])return NO;
...
-(BOOL)isEqualToServiceAccess:(QLFServiceAccess *)other {
    ...
    if (_token != other.token && ![_token isEqual:other.token])return NO;
    
    if (_signature != other.signature && ![_signature isEqual:other.signature])return NO;
    
    if (_keyId != other.keyId)return NO;
...
-(BOOL)isEqualToConversationDescriptor:(QLFConversationDescriptor *)other {
    ...
    if (_rendezvousTag != other.rendezvousTag && ![_rendezvousTag isEqual:other.rendezvousTag])return NO;
    
    if (_rendezvousOwner != other.rendezvousOwner)return NO;
    
    if (_conversationId != other.conversationId && ![_conversationId isEqual:other.conversationId])return NO;
    
    if (_conversationType != other.conversationType && ![_conversationType isEqual:other.conversationType])return NO;
    
    if (_authenticationType != other.authenticationType && ![_authenticationType isEqual:other.authenticationType])return NO;
    
    if (_myKey != other.myKey && ![_myKey isEqual:other.myKey])return NO;
    
    if (_yourPublicKey != other.yourPublicKey && ![_yourPublicKey isEqual:other.yourPublicKey])return NO;
    
    if (_authStatus != other.authStatus)return NO;
...
-(BOOL)isEqualToOwnershipSignature:(QLFOwnershipSignature *)other {
    ...
    if (_op != other.op && ![_op isEqual:other.op])return NO;
    
    if (_nonce != other.nonce && ![_nonce isEqual:other.nonce])return NO;
    
    if (_timestamp != other.timestamp)return NO;
...
-(BOOL)isEqualToRendezvousResponderInfo:(QLFRendezvousResponderInfo *)other {
    ...
    if (_requesterPublicKey != other.requesterPublicKey && ![_requesterPublicKey isEqual:other.requesterPublicKey])return NO;
    
    if (_conversationType != other.conversationType && ![_conversationType isEqual:other.conversationType])return NO;
    
    if (_transCap != other.transCap && ![_transCap isEqual:other.transCap])return NO;
...
-(BOOL)isEqualToRendezvousActivated:(QLFRendezvousActivated *)other {
    ...
    if (_expiresAt != other.expiresAt && ![_expiresAt isEqual:other.expiresAt])return NO;
...
-(BOOL)isEqualToRendezvousDescriptor:(QLFRendezvousDescriptor *)other {
    ...
    if (_tag != other.tag && ![_tag isEqual:other.tag])return NO;
    ...
    if (_requesterKeyPair != other.requesterKeyPair && ![_requesterKeyPair isEqual:other.requesterKeyPair])return NO;
    
    if (_ownershipKeyPair != other.ownershipKeyPair && ![_ownershipKeyPair isEqual:other.ownershipKeyPair])return NO;
...
-(BOOL)isEqualToRendezvousInfo:(QLFRendezvousInfo *)other {
    ...
    if (_numOfResponses != other.numOfResponses)return NO;
    
    if (_responseCountLimit != other.responseCountLimit && ![_responseCountLimit isEqual:other.responseCountLimit])return NO;
    
    if (_expiresAt != other.expiresAt && ![_expiresAt isEqual:other.expiresAt])return NO;
    
    if (_deactivatedAt != other.deactivatedAt && ![_deactivatedAt isEqual:other.deactivatedAt])return NO;
...
-(BOOL)isEqualToSDT:(QLFSDT *)other {
    ...
    if (_v != other.v && ![_v isEqual:other.v])return NO;
...
-(BOOL)isEqualToIndexable:(QLFIndexable *)other {
    ...
    if (_key != other.key && ![_key isEqual:other.key])return NO;
...
-(BOOL)isEqualToConversationMessageMetadata:(QLFConversationMessageMetadata *)other {
    ...
    if (_id != other.id && ![_id isEqual:other.id])return NO;
    
    if (_parentId != other.parentId && ![_parentId isEqual:other.parentId])return NO;
    
    if (_sequence != other.sequence && ![_sequence isEqual:other.sequence])return NO;
    
    if (_sentByMe != other.sentByMe)return NO;
    
    if (_created != other.created && ![_created isEqual:other.created])return NO;
    
    if (_dataType != other.dataType && ![_dataType isEqual:other.dataType])return NO;
    
    if (_values != other.values && ![_values isEqual:other.values])return NO;
...
-(BOOL)isEqualToConversationMessage:(QLFConversationMessage *)other {
    ...
    if (_metadata != other.metadata && ![_metadata isEqual:other.metadata])return NO;
    
    if (_body != other.body && ![_body isEqual:other.body])return NO;
...
-(BOOL)isEqualToServiceAccessInfo:(QLFServiceAccessInfo *)other {
    ...
    if (_serviceAccess != other.serviceAccess && ![_serviceAccess isEqual:other.serviceAccess])return NO;
    
    if (_expirySeconds != other.expirySeconds)return NO;
    
    if (_renegotiationSeconds != other.renegotiationSeconds)return NO;
    
    if (_issuanceDateTimeUTC != other.issuanceDateTimeUTC && ![_issuanceDateTimeUTC isEqual:other.issuanceDateTimeUTC])return NO;
...
-(BOOL)isEqualToOperatorInfo:(QLFOperatorInfo *)other {
    ...
    if (_name != other.name && ![_name isEqual:other.name])return NO;
    
    if (_serviceUri != other.serviceUri && ![_serviceUri isEqual:other.serviceUri])return NO;
    
    if (_accountID != other.accountID && ![_accountID isEqual:other.accountID])return NO;
    
    if (_currentServiceAccess != other.currentServiceAccess && ![_currentServiceAccess isEqual:other.currentServiceAccess])return NO;
    
    if (_nextServiceAccess != other.nextServiceAccess && ![_nextServiceAccess isEqual:other.nextServiceAccess])return NO;
...
-(BOOL)isEqualToVaultKeyPair:(QLFVaultKeyPair *)other {
    ...
    if (_encryptionKey != other.encryptionKey && ![_encryptionKey isEqual:other.encryptionKey])return NO;
    
    if (_authenticationKey != other.authenticationKey && ![_authenticationKey isEqual:other.authenticationKey])return NO;
...
-(BOOL)isEqualToAccessLevelVaultKeys:(QLFAccessLevelVaultKeys *)other {
    ...
    if (_maxAccessLevel != other.maxAccessLevel)return NO;
    
    if (_vaultKeys != other.vaultKeys && ![_vaultKeys isEqual:other.vaultKeys])return NO;
...
-(BOOL)isEqualToVaultKeyStore:(QLFVaultKeyStore *)other {
    ...
    if (_accessLevel != other.accessLevel)return NO;
    
    if (_credentialType != other.credentialType)return NO;
    
    if (_encryptedVaultKeys != other.encryptedVaultKeys && ![_encryptedVaultKeys isEqual:other.encryptedVaultKeys])return NO;
...
-(BOOL)isEqualToVaultInfoType:(QLFVaultInfoType *)other {
    ...
    if (_vaultID != other.vaultID && ![_vaultID isEqual:other.vaultID])return NO;
    
    if (_ownershipPrivateKey != other.ownershipPrivateKey && ![_ownershipPrivateKey isEqual:other.ownershipPrivateKey])return NO;
    
    if (_keyStore != other.keyStore && ![_keyStore isEqual:other.keyStore])return NO;
...
-(BOOL)isEqualToKeychain:(QLFKeychain *)other {
    ...
    if (_operatorInfo != other.operatorInfo && ![_operatorInfo isEqual:other.operatorInfo])return NO;
    
    if (_vaultInfo != other.vaultInfo && ![_vaultInfo isEqual:other.vaultInfo])return NO;
...
-(BOOL)isEqualToVaultItemRef:(QLFVaultItemRef *)other {
    ...
    if (_sequenceId != other.sequenceId && ![_sequenceId isEqual:other.sequenceId])return NO;
    
    if (_sequenceValue != other.sequenceValue)return NO;
    
    if (_itemId != other.itemId && ![_itemId isEqual:other.itemId])return NO;
...
-(BOOL)isEqualToEncryptedVaultItemHeader:(QLFEncryptedVaultItemHeader *)other {
    ...
    if (_ref != other.ref && ![_ref isEqual:other.ref])return NO;
    
    if (_encryptedMetadata != other.encryptedMetadata && ![_encryptedMetadata isEqual:other.encryptedMetadata])return NO;
...
-(BOOL)isEqualToEncryptedVaultItem:(QLFEncryptedVaultItem *)other {
    ...
    if (_header != other.header && ![_header isEqual:other.header])return NO;
    
    if (_encryptedBody != other.encryptedBody && ![_encryptedBody isEqual:other.encryptedBody])return NO;
...
-(BOOL)isEqualToVaultItemQueryResults:(QLFVaultItemQueryResults *)other {
    ...
    if (_results != other.results && ![_results isEqual:other.results])return NO;
    
    if (_current != other.current)return NO;
    
    if (_sequenceIds != other.sequenceIds && ![_sequenceIds isEqual:other.sequenceIds])return NO;
