...
-(void)testConversationHWMComparison {
    {
        ...
        XCTAssertFalse([[[QredoConversationHighWatermark alloc] initWithSequenceValue:[NSData dataWithBytes:a1_bytes
                                                                                                     length:sizeof(a1_bytes)]] isLaterThan:
                        [[QredoConversationHighWatermark alloc] initWithSequenceValue:[NSData dataWithBytes:b1_bytes
                                                                                                     length:sizeof(b1_bytes)]]]);
    }
    ...
    
    {
        ...
        const uint8_t b1_bytes[] = { 0 };
        XCTAssertTrue([[[QredoConversationHighWatermark alloc] initWithSequenceValue:[NSData dataWithBytes:a1_bytes
                                                                                                    length:sizeof(a1_bytes)]] isLaterThan:
                       [[QredoConversationHighWatermark alloc] initWithSequenceValue:[NSData dataWithBytes:b1_bytes
                                                                                                    length:sizeof(b1_bytes)]]]);
    }
