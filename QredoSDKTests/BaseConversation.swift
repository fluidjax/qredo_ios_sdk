...
class BaseConversation: XCTestCase {
    ...
    override func setUp() {
        ...
        // We know we're responding to anonymous rendezvous, so nil trustedRootRefs is fine
        responderClient.respondWithTag(randomTag, trustedRootRefs:nil, completionHandler: { conversation, error in
